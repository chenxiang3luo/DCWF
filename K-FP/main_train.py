...
#     snapshot = SnapshotCallbackBuilder(6,20,6,0.002)
#     X_train,X_test, y_train, y_test = get_base_dataloader()
...
#     print(X_train[0])
    ...
    model.compile(loss="mse", optimizer=OPTIMIZER,
            metrics=None)
    model.fit(X_train, X_train, batch_size=BATCH_SIZE,epochs=NB_EPOCH,validation_split = 0.1,verbose = VERBOSE)
    model.save_weights('./dae_weights.h5')
